...
Single component: **agent/** (Rust) — Local daemon. Watches Claude Code JSONL session files, parses events, stores in SQLite, links git commits, computes diff attribution, posts PR comments with provenance summaries. Local API on `:9847`. 104 tests.
